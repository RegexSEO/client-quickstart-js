$(function () {
	...
	// Bind button to get devices
	document.getElementById('get-devices').onclick = function () {
		navigator.mediaDevices.getUserMedia({ audio: true })
			.then(updateAllDevices.bind(device));
	}

	// Bind button to mute/unmute
	document.getElementById('button-mute').onclick = function (e) {
		if (connection.isMuted()) {
			log('Unmuted');
			e.currentTarget.innerText = "Mute";
			connection.mute(false);
		} else {
			log('Muted');
			e.currentTarget.innerText = "Unmute";
